...
{
	m_tCollisionRect.left = m_tInfo.fX - 35.f;
	m_tCollisionRect.right = m_tInfo.fX + 35.f;
	m_tCollisionRect.top = m_tInfo.fY - 60.f;
	m_tCollisionRect.bottom = m_tInfo.fY + 70.f;
}

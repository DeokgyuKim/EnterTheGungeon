...
void CBox::Render(HDC hDC)
{
	...
	GdiTransparentBlt(hDC, m_tRect.left + tPos.fX, m_tRect.top + tPos.fY, m_tInfo.iCX, m_tInfo.iCY, hMemDC, m_tInfo.iCX * m_iCount, 0, m_tInfo.iCX, m_tInfo.iCY, RGB(255, 0, 255));

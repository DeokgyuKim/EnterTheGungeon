...
void CDoor::Render(HDC hDC)
{
	...
	case DOOR::LEFT:
	case DOOR::RIGHT:
		b = GdiTransparentBlt(hDC, m_tRect.left + tPos.fX, m_tRect.top + tPos.fY, m_tInfo.iCX, m_tInfo.iCY, hMemDC, m_tInfo.iCX * m_tFrame.iFrameStart, 0, m_tInfo.iCX, m_tInfo.iCY, RGB(255, 0, 255));
		break;
	case DOOR::TOP:
	case DOOR::BOTTOM:
		b = GdiTransparentBlt(hDC, m_tRect.left + tPos.fX, m_tRect.top + tPos.fY, m_tInfo.iCX, m_tInfo.iCY, hMemDC, 0, m_tInfo.iCY * m_tFrame.iFrameStart, m_tInfo.iCX, m_tInfo.iCY, RGB(255, 0, 255));
		break;
	default:
		break;
	}
